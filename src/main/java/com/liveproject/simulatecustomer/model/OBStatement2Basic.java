...
public class OBStatement2Basic extends HashMap<String, Object>  {
...
@Size(min=1,max=35) 
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, statementId, statementReference, type, startDateTime, endDateTime, creationDateTime, statementDescription, statementBenefit, statementFee, statementInterest, statementDateTime, statementRate, statementValue, super.hashCode());
  }
