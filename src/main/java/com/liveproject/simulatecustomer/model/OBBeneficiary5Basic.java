...
public class OBBeneficiary5Basic extends HashMap<String, Object>  {
...
@Size(min=1,max=35) 
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, beneficiaryId, beneficiaryType, reference, supplementaryData, super.hashCode());
  }
