...
public class OBTransactionCardInstrument1 extends HashMap<String, Object>  {
  /**
...
@Size(min=1,max=34) 
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cardSchemeName, authorisationType, name, identification, super.hashCode());
  }
